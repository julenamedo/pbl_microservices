...
class Config:
    ...
    PORT = int(environ.get("SERVICE_PORT", '18020'))
    SERVICE_NAME = environ.get("SERVICE_NAME", "machine_b1")
    SERVICE_ID = environ.get("SERVICE_ID", "machine_b1") + "-" + uuid_random_string
    IP = None

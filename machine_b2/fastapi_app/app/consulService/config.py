...
class Config:
    ...
    PORT = int(environ.get("SERVICE_PORT", '18021'))
    SERVICE_NAME = environ.get("SERVICE_NAME", "machine_b2")
    SERVICE_ID = environ.get("SERVICE_ID", "machine_b2") + "-" + uuid_random_string
    IP = None

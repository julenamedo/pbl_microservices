...
class Config:
    ...
    PORT = int(environ.get("SERVICE_PORT", '18019'))
    SERVICE_NAME = environ.get("SERVICE_NAME", "machine_a2")
    SERVICE_ID = environ.get("SERVICE_ID", "machine_a2") + "-" + uuid_random_string
    IP = None
